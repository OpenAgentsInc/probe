...
export const ProbeBackendKind = S.Literals(["apple_fm_bridge"]);
export type ProbeBackendKind = typeof ProbeBackendKind.Type;

export const ProbeBackendAttachMode = S.Literals(["attach_existing"]);
export type ProbeBackendAttachMode = typeof ProbeBackendAttachMode.Type;

export const ProbeBackendAuthMode = S.Literals(["none"]);
export type ProbeBackendAuthMode = typeof ProbeBackendAuthMode.Type;

export const ProbeBackendStreamMode = S.Literals(["snapshot"]);
...
export const ResolvedProbeBackendProfile = S.Struct({
  ...
  baseUrl: S.String,
  baseUrlSource: S.Literals(["explicit", "PROBE_APPLE_FM_BASE_URL", "OPENAGENTS_APPLE_FM_BASE_URL", "default"]),
});
